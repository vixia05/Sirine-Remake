        ...
        <div class="px-4 mx-auto lg:px-8">
            <form method="post" action="{{ route('users.store') }}" autocomplete="off" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div
                        class="px-8 py-4 rounded-2xl bg-white/80 dark:backdrop-blur-sm dark:backdrop-filter dark:bg-slate-800 dark:bg-opacity-70">
                        <h5
                        ...
                        <div class="grid grid-rows-2 mb-6">
                            ...
                            <input type="text" maxlength="4"
                                class="w-full leading-tight border-none rounded-md bg-zinc-100 text-slate-600 drop-shadow-md focus:ring-blue-500 dark:bg-slate-600 dark:bg-opacity-60 dark:text-slate-100"
                        ...
                        <div class="grid grid-rows-2 mb-6">
                            ...
                            <input type="text"
                                class="w-full leading-tight border-none rounded-md bg-zinc-100 text-slate-600 accent-inherit drop-shadow-md focus:ring-blue-500 dark:bg-slate-600 dark:bg-opacity-60 dark:text-slate-100"
                        ...
                        <div class="mb-6 form-control">
                            ...
                            <textarea
                                class="w-full mt-1 leading-tight border-none rounded-md bg-zinc-100 text-slate-600 drop-shadow-md focus:ring-blue-500 dark:bg-slate-600 dark:bg-opacity-60 dark:text-slate-100"
                    ...
                    <div class="grid grid-rows-2 gap-4">
                        <div
                            class="px-8 py-2 rounded-2xl bg-white/80 dark:backdrop-blur-sm dark:backdrop-filter dark:bg-slate-800 dark:bg-opacity-70">
                            <h5
