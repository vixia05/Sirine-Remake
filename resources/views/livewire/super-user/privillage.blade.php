                    ...
                    <div class="overflow-x-auto sm:-mx-6 lg:-mx-8">
                        <div class="inline-block min-w-full sm:px-6 lg:px-8">
                            <table class="min-w-full">
                                <thead
                                    class="border-b border-slate-400 text-base font-bold text-slate-600 dark:text-slate-400">
                                    <tr>
                                        <th scope="col" class="border-x border-slate-400 px-4 py-2 text-center">
                                            No
                                        </th>
                                        <th scope="col" class="border-r border-slate-400 px-4 py-2 text-center">
                                            Level
                                        </th>
                                        <th scope="col" class="border-r border-slate-400 px-4 py-2 text-center">
                                            Role
                                ...
                                <tbody>
                                    @foreach ($data as $datas)
                                        <tr
                                            ...
                                            <td
                                                class="whitespace-nowrap border border-slate-400 px-4 py-2 text-center text-sm font-medium text-slate-800 dark:text-slate-100">
                                                {{ $loop->iteration }}
                                            </td>
                                            <td
                                                class="whitespace-nowrap border border-slate-400 px-4 py-2 text-center text-slate-800 dark:text-slate-100">
                                                {{ $datas->level }}
                                            </td>
                                            <td
                                                class="whitespace-nowrap border border-slate-400 px-4 py-2 text-center text-slate-800 dark:text-slate-100">
