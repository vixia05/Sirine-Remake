        ...
        <div
            ...
            <div
                ...
                <div class="flex flex-col">
                    ...
                    <span class="text-sm text-slate-500 dark:text-slate-400">Periode {{ today()->format('F Y') }}</span>
                </div>
                {{-- 1-A. 1.2 Filter --}}
            ...
            <div class="relative flex flex-col justify-center object-cover w-full h-fit md:h-5/6">
                <canvas wire:ignore id="mainChart" name="mainChart"></canvas>
            </div>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-1 col-span-3 lg:col-span-1 gap-3">
            ...
            <div
                ...
                <div class="flex flex-col pb-3 border-b-2 border-slate-600 dark:border-slate-300">
                    <h5 class="w-full text-xl font-bold text-slate-800 dark:text-slate-100">Total Retur</h5>
                    <span class="text-sm text-slate-500 dark:text-slate-400">5 Tahun Terakhir</span>
                </div>
                {{-- Chart --}}
            ...
            <div
                ...
                {{-- Header --}}
                <div class="flex flex-col pb-3 border-b-2 border-slate-600 dark:border-slate-300">
                    <h5 class="w-full text-xl font-bold text-slate-800 dark:text-slate-100">Jenis Retur</h5>
                    <span class="text-sm text-slate-500 dark:text-slate-400">Periode {{ today()->format('F Y') }}</span>
                </div>
                {{-- Chart --}}
                <div class="object-cover w-full pt-6 h-fit md:h-5/6">
...
<script>
    const ctxMainChart  = document.getElementById('mainChart').getContext('2d');
            ...
            // Total Kelolosan
            const mainChart = new Chart(ctxMainChart, {
                type: 'bar',
                data: {
