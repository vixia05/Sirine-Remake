        ...
        <div class="px-4 pb-4">
            ...
            <div
                ...
                <div class="flex justify-between gap-3 flex-wrap">
                    {{-- 1.1 Filter By Team --}}
                    <div
                        class="flex justify-center text-blue-500 rounded-md focus-within:border-blue-500 focus-within:text-blue-400 focus-within:ring-1 focus-within:ring-blue-400 focus-within:brightness-125 focus-within:shadow-md focus-within:shadow-blue-500/30">
                        <div
            ...
            {{-- Footer --}}
            <div
                class="px-10 pt-2 pb-4 overflow-hidden tracking-wider bg-opacity-50 border-b rounded-b bg-inerhit border-x border-slate-400 text-slate-800 dark:border-slate-600 dark:bg-slate-700 dark:bg-opacity-20 dark:text-slate-100">
