                ...
                <div class="flex flex-wrap justify-between gap-3">
                    ...
                    <div class="flex gap-2 px-2 py-1 text-blue-500 border border-blue-500 rounded focus-within:brightness-125 focus-within:shadow-lg focus-within:shadow-blue-500/20">
                        ...
                        <select wire:model="unit"
                            class="-my-1 -mr-2 text-xs transition duration-150 border-blue-500 border-none rounded-r appearance-none focus:ring-0 bg-slate-800 bg-opacity-10 focus:bg-opacity-100 text-slate-100">
