                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody>
                                        ...
                                        <tr
                                            ...
                                            <td
                                                class="p-3 text-sm whitespace-nowrap text-slate-700 dark:border-slate-500 dark:text-slate-100">
                                            ...
                                            <td
                                                class="p-3 text-sm text-right whitespace-nowrap text-slate-700 dark:border-slate-500 dark:text-slate-100">
                                                {{ number_format(
                                                $datas->blobor +
                                                $datas->hologram +
                                                $datas->miss_reg +
