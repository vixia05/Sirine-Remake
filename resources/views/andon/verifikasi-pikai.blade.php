    ...
    <div x-data="{ verifPcht : '{{ number_format($verifPcht['harian'],0) }}',
        ...
        <div x-show="active == 1"
            ...
            <div
                ...
                <h3 class="pb-1 text-4xl font-semibold text-center border-b-4 text-slate-300">Periksa <span
                        class="text-emerald-300 brightness-125">PCHT</span> Hari Ini</h3>
                <div class="relative flex flex-col justify-center h-full -mt-4">
            ...
            <div class="grid h-[50vh] w-full grid-cols-2 gap-2">
                <div class="flex flex-col gap-2 h-fit">
                    <div
                        ...
                        <h6 class="pb-2 text-2xl font-semibold border-b-2 text-slate-300"><span
                ...
                <div
                    class="px-6 py-4 rounded-lg shadow-md bg-slate-800 bg-opacity-80 shadow-slate-500/40 drop-shadow-lg backdrop-blur backdrop-filter">
                    <h3 class="pb-3 text-4xl font-semibold text-center border-b-4 text-slate-300"><span
        ...
        <div x-show="active == 2"
            ...
            <div
                class="relative h-[40vh] w-full overflow-hidden rounded-lg bg-slate-800 bg-opacity-80 px-6 py-4 shadow-md shadow-slate-500/40 drop-shadow-lg backdrop-blur backdrop-filter">
                <h3 class="pb-1 text-4xl font-semibold text-center border-b-4 text-slate-300">Total Order <span
            ...
            <div class="grid h-[50vh] w-full grid-cols-2 gap-2">
                <div
                    class="h-[25vh] overflow-hidden rounded-lg bg-slate-800 bg-opacity-80 px-6 py-4 shadow-md shadow-slate-500/40 drop-shadow-lg backdrop-blur backdrop-filter">
                    <h6 class="pb-2 text-2xl font-semibold border-b-2 text-slate-300">Sisa Order <span
                ...
                <div
                    class="h-[25vh] overflow-hidden rounded-lg bg-slate-800 bg-opacity-80 px-6 py-4 shadow-md shadow-slate-500/40 drop-shadow-lg backdrop-blur backdrop-filter">
                    <h6 class="pb-2 text-2xl font-semibold text-left border-b-2 text-slate-300">Sisa Order <span
                ...
                <div
                    class="h-[25vh] overflow-hidden rounded-lg bg-slate-800 bg-opacity-80 px-6 py-4 shadow-md shadow-slate-500/40 drop-shadow-lg backdrop-blur backdrop-filter">
                    <h6 class="pb-2 text-2xl font-semibold text-left border-b-2 text-slate-300"> <span
