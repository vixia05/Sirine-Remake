                ...
                <div class="rounded-2xl bg-white shadow-md drop-shadow-md overflow-hidden p-8">
                    <div class="grid grid-cols-3">
                        ...
                        <div class="flex justify-start">
                            <div class="rounded-lg shadow-lg bg-white max-w-sm border">
                                <a href="#!">
                                    <img class="rounded-t-lg" src="https://mdbootstrap.com/img/new/standard/nature/184.jpg"
                                        alt="" />
                                </a>
                                <div class="p-6">
                                    <h5 class="text-gray-900 text-xl font-medium mb-2 text-center">Abdu Rahman</h5>
                        ...
                        <div class="col-span-2">
                            ...
                            <div class="grid grid-cols-6 mb-4 pl-4">
                                ...
                                <div class="col-span-2"><span class="text-sm font-medium leading-tight text-gray-600">Abdu
                                        Rahman</span></div>
                            ...
                            <div class="grid grid-cols-6 mb-4 pl-4">
                                ...
                                <div class="col-span-2"><span
                                        class="text-sm font-medium leading-tight text-gray-600">1234</span></div>
                                <div class="col-span-1"><span class="text-sm font-medium leading-tight">Seksi</span></div>
                                <div class="col-span-2"><span
                                        class="text-sm font-medium leading-tight text-gray-600">Khazanah & Verifikasi Pita
                                        Cukai</span></div>
                            </div>
                            <div class="grid grid-cols-6 mb-4 pl-4">
                                <div class="col-span-1"><span class="text-sm font-medium leading-tight">E-mail</span></div>
                                <div class="col-span-2"><span
                                        class="text-sm font-medium leading-tight text-blue-500 underline">Abdu_Rahman@gmail.com</span>
                                </div>
                                <div class="col-span-1"><span class="text-sm font-medium leading-tight">Unit Kerja</span>
                                </div>
                                <div class="col-span-2"><span
                                        class="text-sm font-medium leading-tight text-gray-600">Verifikasi Pita Cukai</span>
                                </div>
                            </div>
                            <div class="grid grid-cols-6 mb-4 pl-4">
                                <div class="col-span-1"><span class="text-sm font-medium leading-tight">Contact</span></div>
                                <div class="col-span-2"><span
                                        class="text-sm font-medium leading-tight text-gray-600">0813-1646-1691</span></div>
                                <div class="col-span-1"><span class="text-sm font-medium leading-tight">Alamat</span></div>
                                <div class="col-span-2"><span class="text-sm font-medium leading-tight text-gray-600">Lorem
                                        ipsum, dolor sit amet consectetur adipisicing elit.
                                        Consequuntur repellat rem dolore impedit cumque itaque.</span></div>
                            </div>
                            {{-- 2. Button Ubah Data --}}
