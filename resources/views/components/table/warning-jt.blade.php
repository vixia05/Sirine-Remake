                    ...
                    <table class="min-w-full">
                        ...
                        <tbody>
                            ...
                            <tr
                                ...
                                <td
                                    class="px-3 py-1 text-xs text-center  whitespace-nowrap border-slate-300 text-slate-900 dark:border-slate-500 dark:text-slate-100 ">
                                    <span class="rounded-full bg-yellow-400 px-3 py-1 drop-shadow-md text-yellow-900 font-medium">
                                        7 Days Ago
                                    </span>
                                </td>
                                <td
                            ...
                            <tr
                                ...
                                <td
                                    class="px-3 py-1 text-xs text-center  whitespace-nowrap border-slate-300 text-slate-900 dark:border-slate-500 dark:text-slate-100 ">
                                    <span class="rounded-full bg-green-400 px-3 py-1 drop-shadow-md text-green-50 font-medium">
                                        3 Days Ago
                                    </span>
                                </td>
                                <td
