<x-modal.app-edit>
    ...
    <div class="flex flex-col mb-2">
        <label class="text-center inline-block py-1 font-medium text-slate-600 text-sm dark:text-slate-200"
            for="tglVerif">Tanggal Verifikasi</label>
        <input type="date" wire:model='tglVerif' id="tglVerif"
    ...
    <div class="mb-2 grid grid-cols-2 gap-4">
        ...
        <div class="flex flex-col">
            <label class="inline-block py-1 font-medium text-slate-600 text-sm dark:text-slate-200" for="noPo">Nomor PO</label>
            <input disabled type="text" wire:model='noPo' id="noPo"
                class="w-full leading-tight text-sm border-slate-300 rounded-md bg-slate-300 text-slate-600 transition duration-300 ease-in-out focus:ring-blue-500/80 dark:bg-slate-600 dark:bg-opacity-60 dark:text-slate-100">
        </div>
        {{-- 2. Nama --}}
        <div class="flex flex-col">
            <label class="inline-block py-1 font-medium text-slate-600 text-sm dark:text-slate-200">Nomor OBC</label>
    ...
    <div class="grid grid-cols-2 gap-4 mt-4 md:grid-cols-4">
        ...
        <div>
            <label for="diecut" class="inline-block py-1 font-medium text-slate-600 text-sm dark:text-slate-200" for="wip">WIP /
                Sisa Baik</label>
    ...
    <div class="mt-6">
        <div class="flex flex-col col-span-2 md:col-span-4 lg:col-span-6">
            <label for="evaluasi" class="inline-block py-1 font-medium text-slate-600 text-sm dark:text-slate-200"
                for="">Keterangan</label>
            <textarea id="evaluasi"
                class="w-full leading-tight text-sm border-slate-400/60 rounded-md text-slate-600 hover:border-blue-500 transition duration-300 ease-in-out focus:ring-blue-500/80 dark:bg-slate-600 dark:bg-opacity-60 dark:text-slate-100"
