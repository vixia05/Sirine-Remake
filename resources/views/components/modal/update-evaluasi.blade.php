...
<div class="mb-2 grid grid-rows-2 gap-4">
    ...
    <div class="flex flex-col gap-2">
        ...
        <textarea rows="3"
            class="appearance-none rounded border-slate-300 bg-zinc-300/60 p-4 text-sm tracking-wide text-slate-800 transition duration-150 ease-in-out focus:outline-double focus:outline-2 focus:outline-blue-500 focus:ring-2 focus:ring-blue-500/40 dark:border-slate-600 dark:bg-slate-500/40 dark:text-slate-100"></textarea>
    </div>
