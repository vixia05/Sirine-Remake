    ...
    <div class="relative flex flex-col justify-center p-6">
        <div
            ...
            <div class="w-full px-4 py-3">
                {{-- 1.0 Header Section --}}
                <div class="grid grid-cols-1 md:grid-cols-2 gap-3 border-b-2 border-slate-600/70 pb-3 dark:border-slate-300">
                    {{-- 1.1 Header Title --}}
                    ...
                    <div class="my-auto flex justify-end flex-wrap">
                        <select
                            class="w-full md:w-fit rounded-l border-blue-400 py-2 pl-2 text-sm font-bold text-slate-700 focus:bg-opacity-100 dark:bg-slate-700 dark:bg-opacity-30 dark:text-slate-200"
                            id="team" name="team">
                        ...
                        <select
                            class="w-full md:w-fit border-blue-400 py-2 pl-2 text-sm font-bold text-slate-700 focus:bg-opacity-100 dark:bg-slate-700 dark:bg-opacity-30 dark:text-slate-200"
                            id="mode" name="mode">
            ...
            <div class="flex h-[50vh] md:h-[80vh] w-full flex-col overflow-auto px-8 py-2 shadow drop-shadow-md">
