<div x-show="!showSideBar"
    class="fixed hidden w-64 min-h-full mt-0 ml-0 overflow-hidden overflow-y-auto bg-gray-100 shadow-md drop-shadow-md md:block"
        ...
        <nav class="relative">
            <div id="sideNav">
                <ul class="relative px-5 pt-2">
                    ...
                    {{-- Menu Super User --}}
                    <h6
                        class="px-3 py-3 text-base font-bold leading-tight text-gray-600 text-ellipsis whitespace-nowrap drop-shadow-lg">
                        Super User
                    </h6>
                    <li class="relative my-2">
