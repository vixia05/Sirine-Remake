<h6
    ...
    class="absolute px-3 py-2 mb-12 text-base font-bold leading-tight duration-300 ease-in-out text-ellipsis whitespace-nowrap drop-shadow-lg dark:text-gray-200">
    Andon
</h6>
<h6
    :class="!expandNavbar ? 'opacity-100' : 'opacity-0'"
...
<div class="mt-12">
{{-- 1.0 Khazwal Pita Cukai --}}
    @if (Helper::getUnit() === 2 || Helper::getRole() > 0)
        <li class="relative mb-1.5">
            <a class="{{ Route::is('andon.khazwalPikai') ? ' bg-blue-600 shadow-blue-600/50 dark:bg-blue-500 dark:shadow-blue-500/50 rounded-md shadow-lg brightness-125 text-slate-50' : 'text-slate-600 dark:text-slate-300 dark:hover:text-slate-50 hover:text-slate-900 dark:hover:bg-slate-400/10 hover:bg-slate-500 hover:bg-opacity-10 hover:font-semibold' }} flex gap-3 items-center overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-xs transition duration-300 ease-in-out"
                ...
                <span class="tracking-wide font-medium" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Khazwal Pita Cukai</span>
            </a>
        </li>
    @endif
{{-- 1.0 Cetak Pita Cukai --}}
    @if (Helper::getUnit() === 3 || Helper::getRole() > 0)
        <li class="relative my-1.5">
            <a class="{{ Route::is('andon.cetakPikai') ? ' bg-blue-600 shadow-blue-600/50 dark:bg-blue-500 dark:shadow-blue-500/50 rounded-md shadow-lg brightness-125 text-slate-50' : 'text-slate-600 dark:text-slate-300 dark:hover:text-slate-50 hover:text-slate-900 dark:hover:bg-slate-400/10 hover:bg-slate-500 hover:bg-opacity-10 hover:font-semibold' }} flex gap-3 items-center overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-xs transition duration-300 ease-in-out"
                ...
                <span class="tracking-wide font-medium" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Cetak Pita Cukai</span>
            </a>
        </li>
    @endif
{{-- 1.0 Verifikasi Pita Cukai --}}
    @if (Helper::getUnit() === 4 || Helper::getRole() > 0)
        <li class="relative my-1.5">
            <a class="{{ Route::is('andon.verifPikai') ? ' bg-blue-600 shadow-blue-600/50 dark:bg-blue-500 dark:shadow-blue-500/50 rounded-md shadow-lg brightness-125 text-slate-50' : 'text-slate-600 dark:text-slate-300 dark:hover:text-slate-50 hover:text-slate-900 dark:hover:bg-slate-400/10 hover:bg-slate-500 hover:bg-opacity-10 hover:font-semibold' }} flex gap-3 items-center overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-xs transition duration-300 ease-in-out"
                ...
                <span class="tracking-wide font-medium" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Verifikasi Pita Cukai</span>
            </a>
        </li>
    @endif
{{-- 1.0 Khazkhir Pita Cukai --}}
    @if (Helper::getUnit() === 5 || Helper::getRole() > 0)
        <li class="relative my-1.5">
            <a class="{{ Route::is('andon.khazkhirPikai') ? ' bg-blue-600 shadow-blue-600/50 dark:bg-blue-500 dark:shadow-blue-500/50 rounded-md shadow-lg brightness-125 text-slate-50' : 'text-slate-600 dark:text-slate-300 dark:hover:text-slate-50 hover:text-slate-900 dark:hover:bg-slate-400/10 hover:bg-slate-500 hover:bg-opacity-10 hover:font-semibold' }} flex gap-3 items-center overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-xs transition duration-300 ease-in-out"
                ...
                <span class="tracking-wide font-medium" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Khazkhir Pita Cukai</span>
            </a>
        </li>
    @endif
</div>
