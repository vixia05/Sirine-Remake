...
<li class="{{ Route::is('inputVerifikasi.index') || Route::is('inputRetur.index') || Route::is('inputEvaluasi.index') ? ' bg-slate-300 bg-opacity-30 dark:bg-opacity-10 rounded-md dark:text-gray-300 p-1' : '' }} relative my-1.5"
    ...
    <a class="flex cursor-pointer justify-between space-x-3 overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-sm text-slate-600 transition duration-300 ease-in-out hover:bg-slate-500 hover:bg-opacity-10 hover:font-medium hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-400/10 dark:hover:text-slate-50"
        ...
        <div class="flex gap-3 items-center">
            ...
            <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Input Data</span>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="ml-auto h-[19px] w-[19px] flex-shrink-0" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" stroke-width="2">
    ...
    <ul class="{{ Route::is('inputVerifikasi.index') || Route::is('inputRetur.index') || Route::is('inputEvaluasi.index') ? 'show' : '' }} collapse accordion-collapse relative"
        ...
        <li class="relative my-1.5">
            <a href="{{ route('inputEvaluasi.index') }}"
                ...
                <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Pesan
                    Evaluasi
                </span>
            </a>
        </li>
...
<li class="{{ Route::is('rekapVerif.index') || Route::is('rekapRetur.index') || Route::is('rekapEvaluasi.index') ? ' bg-slate-300 bg-opacity-30 dark:bg-opacity-10 rounded-md dark:text-gray-300 p-1' : '' }} relative w-full rounded-lg"
    ...
    <a class="flex cursor-pointer justify-between space-x-3 overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-sm text-slate-600 transition duration-300 ease-in-out hover:bg-slate-500 hover:bg-opacity-10 hover:font-medium hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-400/10 dark:hover:text-slate-50"
        ...
        <div class="flex gap-3 items-center">
            ...
            <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Rekap Data</span>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="ml-auto h-[19px] w-[19px] flex-shrink-0" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
        ...
        <li class="relative my-1.5">
            <a href="{{ route('rekapEvaluasi.index') }}"
                ...
                <div class="flex gap-3 items-center">
                    ...
                    <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Rekap
                        Evaluasi</span>
                </div>
            </a>
        </li>
...
<li class="{{ Route::is('quantity.unit') || Route::is('quantity.individu') ? ' bg-slate-300 bg-opacity-30 dark:bg-opacity-10 rounded-md dark:text-gray-300 p-1' : '' }} relative my-1.5 rounded-md dark:text-gray-200"
    ...
    <a class="flex cursor-pointer items-center justify-between overflow-hidden text-ellipsis whitespace-nowrap rounded-lg py-[6px] px-2.5 mx-1 text-sm text-slate-600 transition duration-300 ease-in-out hover:bg-slate-500 hover:bg-opacity-10 hover:font-medium hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-400/10 dark:hover:text-slate-50"
        ...
        <div class="flex gap-3 items-center">
            ...
            <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Performa Quantity</span>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="ml-auto h-[19px] w-[19px] flex-shrink-0" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
    ...
    <ul class="{{ Route::is('quantity.unit') || Route::is('quantity.individu') ? 'show' : '' }} collapse accordion-collapse relative"
        ...
        <li class="relative my-1.5">
            <a href="{{ route('quantity.unit') }}"
                ...
                data-mdb-ripple="true" data-mdb-ripple-color="light">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-[19px] w-[19px] flex-shrink-0" :class="expandNavbar ? 'ml-2' : '' " fill="none"
                    viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                </svg>
                <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Unit
                </span>
            </a>
        </li>
        <li class="relative my-1.5">
...
<li class="{{ Route::is('quality.unit') || Route::is('quality.individu') ? ' bg-slate-300 bg-opacity-30 dark:bg-opacity-10 rounded-md dark:text-gray-300 p-1' : '' }} relative my-1.5 rounded-md dark:text-gray-200"
    ...
    <a class="flex cursor-pointer items-center justify-between overflow-hidden text-ellipsis whitespace-nowrap rounded-lg py-[6px] px-2.5 mx-1 text-sm text-slate-600 transition duration-300 ease-in-out hover:bg-slate-500 hover:bg-opacity-10 hover:font-medium hover:text-slate-900 dark:text-slate-300 dark:hover:bg-slate-400/10 dark:hover:text-slate-50"
        ...
        <div class="flex gap-3 items-center">
            ...
            <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Performa Quality</span>
        </div>
        <svg xmlns="http://www.w3.org/2000/svg" class="ml-auto h-[19px] w-[19px] flex-shrink-0" fill="none" viewBox="0 0 24 24"
            stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M19 9l-7 7-7-7" />
    ...
    <ul class="{{ Route::is('quality.unit') || Route::is('quality.individu') ? 'show' : '' }} collapse accordion-collapse relative"
        ...
        <li class="relative my-1.5">
            <a href="{{ route('quality.individu') }}"
                ...
                <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Individu
                </span>
            </a>
        </li>
    </ul>
...
<li class="relative my-1.5">
    <a class="{{ Route::is('report') ? ' bg-blue-600 shadow-blue-600/50 dark:bg-blue-500 dark:shadow-blue-500/50 rounded-md shadow-lg brightness-125 text-slate-50 font-medium' : 'text-slate-600 dark:text-slate-300 dark:hover:text-slate-50 hover:text-slate-900 dark:hover:bg-slate-400/10 hover:bg-slate-500 hover:bg-opacity-10 hover:font-medium' }} flex gap-3 items-center overflow-hidden whitespace-nowrap rounded-lg py-1.5 px-2.5 mx-1 text-sm transition duration-300 ease-in-out"
        ...
        <span class="tracking-wide duration-300 ease-in-out" :class="expandNavbar ? 'opacity-100' : 'opacity-0'">Report Pegawai</span>
    </a>
</li>
