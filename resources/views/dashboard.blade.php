    ...
    <div class="py-6">
        <div class="px-6 mx-auto lg:px-8">
            ...
            <div class="grid grid-cols-2 gap-2 md:gap-4 lg:grid-cols-4">
                {{-- 1.1 Order Pcht --}}
                <div
                    class="order-1 px-2 py-4 overflow-hidden bg-white bg-opacity-50 rounded-xl backdrop-blur-sm backdrop-filter dark:bg-slate-900 dark:bg-opacity-40 dark:backdrop-blur-sm dark:backdrop-filter md:py-4 md:px-6">
                ...
                {{-- 1.2 Sisa Order PCHT --}}
                <div
                    class="order-3 px-2 py-4 overflow-hidden bg-white bg-opacity-50 md:order-2 rounded-xl backdrop-blur-sm backdrop-filter dark:bg-slate-900 dark:bg-opacity-40 dark:backdrop-blur-sm dark:backdrop-filter md:py-4 md:px-6">
                    <div class="flex flex-col items-center justify-between h-full gap-2 md:flex-row">
                        <div class="my-1 text-center md:text-left">
                            <h6 class="mb-2 font-sans text-sm text-slate-800 dark:text-slate-300">
                                SISA PCHT
                ...
                {{-- 1.3 Order Mmea --}}
                <div
                    class="order-2 px-2 py-4 overflow-hidden bg-white bg-opacity-50 md:order-3 rounded-xl backdrop-blur-sm backdrop-filter dark:bg-slate-900 dark:bg-opacity-40 dark:backdrop-blur-sm dark:backdrop-filter md:py-4 md:px-6">
                    <div class="flex flex-col items-center justify-between h-full gap-2 md:flex-row">
                        <div class="my-1 text-center md:text-left">
                            <h6 class="mb-2 font-sans text-sm text-slate-800 dark:text-slate-300">
                                ORDER MMEA
                ...
                {{-- 1.4 Sisa Order Mmea --}}
                <div
                    class="order-4 px-2 py-4 overflow-hidden bg-white bg-opacity-50 rounded-xl backdrop-blur-sm backdrop-filter dark:bg-slate-900 dark:bg-opacity-40 dark:backdrop-blur-sm dark:backdrop-filter md:py-4 md:px-6">
                    <div class="flex flex-col items-center justify-between h-full gap-2 md:flex-row">
                        <div class="my-1 text-center md:text-left">
                            <h6 class="mb-2 font-sans text-sm text-slate-800 dark:text-slate-300">
                                SISA MMEA
            ...
            <div class="grid grid-cols-4 gap-2 mt-5 md:gap-4">
                <div class="grid grid-flow-col col-span-4 grid-rows-2 gap-3 lg:col-span-1">
                    {{-- 2.1 Inschiet Pcht --}}
                    <div
                        class="row-span-2 px-8 py-4 overflow-hidden bg-white bg-opacity-50 shadow-sm dark:backdrop-blur-smbackdrop-filter rounded-xl backdrop-blur-sm dark:bg-slate-900 dark:bg-opacity-40 lg:row-span-1">
                    ...
                    {{-- 2.2 Inschiet Mmea --}}
                    <div
                        class="h-full row-span-2 px-8 py-4 overflow-hidden bg-white bg-opacity-50 shadow-sm dark:backdrop-blur-smbackdrop-filter rounded-xl backdrop-blur-sm dark:bg-slate-900 dark:bg-opacity-40 lg:row-span-1">
                ...
                <div class="col-span-4 lg:col-span-3">
                    <div
                        class="h-full px-8 py-4 overflow-hidden bg-white bg-opacity-50 shadow-sm dark:backdrop-blur-smbackdrop-filter rounded-xl backdrop-blur-sm dark:bg-slate-900 dark:bg-opacity-40">
                        <h5
